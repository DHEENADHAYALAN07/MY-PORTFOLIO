...
function downloadResume() {
  ...
  link.href = "DHEENADHAYALAN S_ IT_ RESUME.pdf"; // Replace with your actual resume path
  link.download = "Dheena_Resume.pdf"; // Desired file name for download
...
function viewResume() {
  window.open("DHEENADHAYALAN S_ IT_ RESUME.pdf", "_blank"); // Replace with your actual resume path
}
